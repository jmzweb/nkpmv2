<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FAllReportmaxNew.aspx.cs" Inherits="NTJT.Web.WorkAsp.Report.FAllReportmaxNew" %>
            ...
            <tbody>
                <% 
                    ...
                    for (var i = 0; i < ProInfo.Rows.Count; i++)
                    {
                        ...
                        htmlstr += "<td><a K_AUTOID='" + drf["K_AUTOID"] + "'>" + drf["PROJECTNAME"] + "</a></td><td>" + drf["CITYD"] + "</td><td>" + drf["TRADEG_1_D"] + "</td>";
                        htmlstr += "<td>" + drf["PROJECTNODE"] + "</td><td>" + drf["K_UPDATETIME"] + "</td></tr>\r\n";//企业名称所在城市所属行业
                    }                                                                                                                       
                %>
                <%=htmlstr%>
            </tbody>
