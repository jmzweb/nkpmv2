<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GQProReportmax.aspx.cs" Inherits="NTJT.Web.WorkAsp.Report.GQProReportmax" %>
                ...
                <% 
                    ...
                    for (var i = 0; i < ProInfo.Rows.Count; i++)
                    {
                        ...
                        htmlstr += "<td><a K_AUTOID='" + drf["K_AUTOID"] + "'>" + drf["PROJECTNAME"] + "</a></td><td>" + CvnStrByObj(drf["INVESTMENTIME"]) + "</td>" +//项目名称投资时间
                            "<td class='comdify'>" + drf["INVESTMENMOENY"] + "</td>";
