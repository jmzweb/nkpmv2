<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="EZ.Web.Home" %>
...
<head>
    ...
    <script type="text/javascript">
        if (window.parent["switchDeskTop"] != null) {
            window.parent["switchDeskTop"](1);
        }
        ...
        $(function () {
            ...
            $(".labelZone .bizlabel").click(function () {
                ...
                jQuery.cookie("selTab", biz);

            });

            var selTab = jQuery.cookie("selTab");
            if (!!selTab) {
                $(".bizlabel[biz='" + selTab + "']").click();
            }
    ...
    <style type="text/css">
        ...
        .unread{background:white url(img/email/mail.png) no-repeat 3px 3px;padding-left:24px;}
        .readed{background:white url(img/email/readed.gif) no-repeat 3px 3px;padding-left:24px;color:#777; }
        .readed a{color:#777;}
        .item a{line-height:22px;height:22px;padding:3px;}
        .item a:hover{color:white;background:#3a6ea5;text-decoration:none;}
        .top{margin-left:5px;vertical-align:text-bottom;}
...
<div id="mainframe" >
    <table width="100%" align="center">
        ...
        <td valign="top" width="60%">
             <div class="wrapper" >
	            <div class="caption">
                <a href="SysFolder/Workflow/FlowToDo.aspx" target="_self">待办事项</a>&nbsp;
                <span class="itemnum"><%=iToDo %></span>&nbsp;
                <%=sbLeaderToDo %>
                </div>
                <div class="labelZone">
                    <%=sbLabel %>
        ...
        <td valign="top">
            ...
            <div class="wrapper" >
	            <div class="caption">
                <a href="SysFolder/AppFrame/AppQuery.aspx?tblName=Q_OA_GW_Query" target="_self">公文查阅</a><span class="itemnum"><%=iFile %></span>
                </div>
            ...
            <!--
            <div class="wrapper" >
	            <div class="caption">协同任务<span class="itemnum"></span></div>
	            <div class="content" id="Div2">
                    <iframe src="WorkAsp/Portal/TaskPortal.aspx" frameborder="0" width="100%" height="200"></iframe>
	            </div>
            </div>
            -->
            <div class="wrapper" >
