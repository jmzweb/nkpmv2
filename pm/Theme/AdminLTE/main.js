...
(function ($, AdminLTE) {
  ...
  //Create the menu
  var right_settings = $("<div />");

  //Layout options
  right_settings.append(
  ...
  right_settings.append("<h4 class='control-sidebar-heading'>选择皮肤</h4>");
  right_settings.append(skins_list);

  tab_pane.append(right_settings);
