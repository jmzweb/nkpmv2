    ...
    <form id="form1" action="WeOfficeSave.aspx" enctype="multipart/form-data">
	 <div>
        <object id="TANGER_OCX" classid="clsid:C9BC4DFF-4248-4a3c-8A49-63A7D317F404"    
            codebase="OfficeControl.cab#version=5,0,2,4" width="100%" height="800px;">   
            ...
            <param name="ProductCaption" value="风帆股份有限公司">
            <param name="ProductKey" value="F3DFBECF00C1EBFC36B3969FF63032F117BA9CE4">
