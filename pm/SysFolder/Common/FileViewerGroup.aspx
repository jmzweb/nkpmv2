<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileViewerGroup.aspx.cs" Inherits="EZ.WebBase.SysFolder.Common.FileViewerGroup" %>
	...
	<style type="text/css">
		*{margin:0px;padding:0px;}
		...
		li{
            ...
            background:#eee url(../../img/common/topbar.gif) repeat-x;
