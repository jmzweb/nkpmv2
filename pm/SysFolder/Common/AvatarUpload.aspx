<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AvatarUpload.aspx.cs" Inherits="EZ.WebBase.SysFolder.Common.AvatarUpload" %>
...
<body style="background:white;overflow:hidden;" >
	...
	<div style="<%=read%>;text-align:left;">
		<input type="file" name="uploadify" id="uploadify" class="hidden" /> 
