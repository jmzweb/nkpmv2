...
<head id="Head1" runat="server">
    ...
    *{
    ...
    button,input[type=button],input[type=submit]
    {
        ...
        color:#333;
        background:url(../../img/btn01.gif) 0px 0px;
        overflow:visible;
        cursor:pointer;
    }
	...
	#fromMyDoc{position:absolute;left:80px;cursor:pointer; width:100px;height:21px;line-height:120%;color:#0068B7;padding:1px 5px;z-index:99;border:1px solid #AABED3;<%=fromDoc%>}
	#downPacked{position:absolute;left:185px;cursor:pointer; width:90px;height:21px;line-height:120%;color:#0068B7;padding:1px 5px;z-index:99;border:1px solid #AABED3;}
	#wxUpload{display:none;left:280px;cursor:pointer; width:90px;height:21px;line-height:120%;color:#0068B7;padding:1px 5px;z-index:99;border:1px solid #AABED3;}
	</style>
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#uploadify").uploadify({
                ...
                'formData': {appName:"<%=appName %>",appId:"<%=appId %>",folder:"<%=folder %>",'ASPSESSID': _auid, 'AUTHID': _auth},
            ...
            //微信拍照上传
            jQuery("#wxUpload").appendTo("#uploadify").click(function(){

                //var uploadId = EZ.WebBase.SysFolder.Common.FileListFrame.Upload_Begin(["<%=appName %>","<%=appId %>"]).value;
                var dlg = new $.dialog({ title: '微信拍照上传', page: "../Common/QRCode.aspx?t=filelist&appName=<%=appName %>&appId=<%=appId %>"
                    , xButton:false, maxBtn:false, btnBar: true, cover: true, width: 400, height: 300, bgcolor: 'gray', cancelBtnTxt: '关闭',
                    onCancel: function () {
                        //EZ.WebBase.SysFolder.Common.FileListFrame.Upload_End(uploadId);
            ...
            jQuery(".editlink").live("click",function(){
                var fileid=$(this).attr("fileid");
            ...
            $(".lnkbc").live("click",function(){
                ...
                var ret = EZ.WebBase.SysFolder.Common.FileListFrame.RenameFile(fileId, newName);
	            if (ret.error) {
...
<body style="background:white;" >
	...
	<div style="text-align:left;" class="<%=read=="1"?"hidden":"" %>">
	    ...
	    <input class="btn_sub" id="wxUpload" type="button" value="微信拍照" />
