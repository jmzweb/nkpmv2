<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NeatUpload.aspx.cs" EnableSessionState="false" Inherits="EZ.WebBase.SysFolder.Common.NeatUpload" %>
...
<body>
    ...
    <div style="padding:0px 5px;">
        选择文件：&nbsp;&nbsp;
        <Upload:InputFile id="FileInput" Width="310" runat="server" />    
