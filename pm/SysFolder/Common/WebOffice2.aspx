...
<script language="javascript" type="text/javascript">
    ...
    function newControlStyle() {
        ...
        var crt = document.all("hiddenControl").value;
        if (crt == 1) {
            for (var menuPos = 1; menuPos < 4; menuPos++) {
                ...
                if (menuPos == 2) {
                    ...
                    var yzstr = document.all("hiddenYz").value;
                    if (yzstr != "" && yzstr != null) {
                        var sp1 = yzstr.split("$");
                        if (sp1.length > 1) {
                            var count = sp1[0];
                ...
                if (menuPos == 3) {
                    ...
                    for (var submenuPos = 0; submenuPos < 2; submenuPos++) {
                        if (0 == submenuPos)//增加菜单项目
                        {
                            ...
                            var thstr = document.all("hiddenTh").value;
                        ...
                        if (1 == submenuPos)//增加菜单项目
                        {
                            ...
                            var mbstr = document.all("hiddenMb").value;
        ...
        var mburl = document.all("hiddenMbUrl").value;
        var mbload = document.all("hiddenMbLoad").value;
        if (mburl != "" && mburl != null) {
            if (mbload != "1") {
                document.all("hiddenMbLoad").value = 1;
...
<body onload='onload("<%=filename %>","<%=newofficetype %>");' onunload ="onPageClose();" scroll="yes">
    ...
    <div id="officecontrol">
        ...
        <script type="text/javascript" for="TANGER_OCX" event="OnDocumentOpened(TANGER_OCX_str,TANGER_OCX_obj);">
            ...
            {
                UserName = document.all("hiddenUserName").value;
            }

	        var mark = document.all("hiddenMark").value;
	        if(mark == 0)
	        {
	        ...
	        var saveas = document.all("hiddenSaveas").value;
	        if(saveas == 1)
	        {
	            setFileSaveAs(true); 
	        }
	        ...
	        var filenew = document.all("hiddenFilenew").value;
	        if(filenew == 1)
	        {
	            setFileNew(true);
	        }
	        ...
	        var copy = document.all("hiddenCopy").value;
	        if(copy == 1)
	        {
	            setIsNoCopy(false);
	        }
	        ...
	        var readonly = document.all("hiddenReadonly").value;
	        if(readonly == 0)
	        {
	        ...
	        var print = document.all("hiddenPrint").value;
	        if(print == 1)
	        {
	            setFilePrint(true);
	        }
	        ...
	        var fullscrn = document.all("hiddenFullScrn").value;
	        if(fullscrn == 1)
	        {
        ...
        <script type="text/javascript" for="TANGER_OCX" event="OnCustomMenuCmd2(menuPos,submenuPos,subsubmenuPos,menuCaption,menuID)">
			...
			if(yzstr!="" && yzstr!=null)
			{
			    ...
			    {  
			        ...
			        var str3 = sp2[i];
			        var sp3 = str3.split(",");
			        if(sp3[0]==menuCaption)addServerSign(sp3[1]);
			    }
			}
			var thstr = document.all("hiddenTh").value;
			if(thstr!="" && thstr!=null)
	    ...
	    <script type="text/javascript">
	        function setBookMark(mark) {
	            ...
	            var elObj = window.parent.parent.document.getElementById("input" + fieldinput);
	            var inputValue = elObj.value;
