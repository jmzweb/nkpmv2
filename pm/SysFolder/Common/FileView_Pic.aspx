<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileView_Pic.aspx.cs" Inherits="EZ.WebBase.SysFolder.Common.FileView_Pic" %>
...
<body>
    ...
    <div class="mainPanel">
        <img id="mainPic" src="fileDown.aspx?fileId=<%=base.GetParaValue("fileId") %>&log=view" alt="查看图片" />
    </div>
</body>
</html>