<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUpload.aspx.cs" Inherits="EZ.WebBase.SysFolder.Common.FileUpload" %>
	...
	<script type="text/javascript">
	    window.addEvent('domready', function() {
	        ...
	        var up = new FancyUpload3.Attach('demo-list', '#demo-attach, #demo-attach-2', {
	            ...
	            url: "../../FancyUpload.axd?appName=<%=AppName %>&appId=<%=AppId %>&folderId=<%=folderId %>&ASPSESSID="+ASPSESSID+"&AUTHID="+auth,
...
<body class="bgbody">
    <form id="form1" runat="server">
        <div class="maindiv">
            ...
            <label class="error">（每个文件最大100M）</label>
            <ul id="demo-list"></ul>
        </div>
    </form>
</body>
