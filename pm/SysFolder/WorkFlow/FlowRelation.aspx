<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowRelation.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.FlowRelation" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .selpanel{border:0px solid #eee;width:800px;margin-top:5px;height:130px;overflow:hidden;}
            ...
            $(".tabs>li").click(function () {
                ...
                if (i > 0) {
                    ...
                    if (!f) {
                        $(this).data("load", "1");
                        if (i == 1)
                            $("#frame" + i)[0].src = "FlowRelation_MyPart.aspx";
                        else if (i == 2)
                            $("#frame" + i)[0].src = "FlowRelation_PosPart.aspx";
                        else if (i == 3)
...
<body>
    ...
    <div id="maindiv">
        <ul class="tabs" style="margin-bottom:0px;">
            <li class="selected"><a href="#tabpage1" >我发起的任务</a></li>
            <li ><a href="#tabpage1" >我参与的任务</a></li>
            <li ><a href="#tabpage1" >岗位参与的任务</a></li>

            <li class="<%=deptClass %>"><a href="#tabpage2" >本部门发起的</a></li>
            <li class="<%=companyClass %>"><a href="#tabpage3" >本公司发起的</a></li>
        </ul>
        <div id="tabControl" style="height:390px;width:800px;margin-left:auto;margin-right:auto;margin-top:0px;">
            <div>
            ...
            <div class="hidden">
                <iframe id="frame3" src="" width="100%" height="100%" frameborder="0"></iframe>
            </div>
            <div class="hidden">
                <iframe id="frame4" src="" width="100%" height="100%" frameborder="0"></iframe>
            </div>
        </div>
        <div class="selpanel">
            <div class="box-frame">
