<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowErrorInfo.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.FlowErrorInfo" %>
                ...
                <table width="90%" align="center">
                    ...
                    <tr>
                        ...
                        <td style="padding:10px 20px;">
                            <input type="button" value=" 返 回 " class="<%=backCls %>" onclick="window.history.back();"/>&nbsp;
                            <input type="button" value=" 更 多 " class="<%=moreCls %>" onclick="toggleMore();"/>&nbsp;
