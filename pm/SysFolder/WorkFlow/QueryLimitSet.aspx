<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryLimitSet.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.QueryLimitSet" %>
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            $("#TextBox1").attr("emptytip", "<请双击选择部门>").attr("readOnly", true).dblclick(function () {
                openpage('../Common/DeptTree.aspx?method=2&queryfield=deptid,deptname&cid=HiddenField1,TextBox1');
            });
...
<body>
    ...
    <div id="maindiv">
        <table width="700" style="margin-left:auto;margin-right:auto;">
            <tbody>
                <tr>
