<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_OnDeal.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.Admin_OnDeal" %>
...
<!--
    var _curClass = EZ.WebBase.SysFolder.WorkFlow.Admin_OnDeal;
    $("#flex1").flexigrid
	({
