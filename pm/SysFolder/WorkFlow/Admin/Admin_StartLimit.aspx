<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_StartLimit.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.Admin.Admin_StartLimit" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .maintbl{margin-left:auto;margin-right:auto;text-align:center;}
    </style>
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            $("#TextBox1").attr("emptytip", "<请双击选择部门>").attr("readOnly", true).dblclick(function () {
                openpage('../../Common/DeptTree.aspx?method=2&queryfield=deptwbs,deptname&cid=HiddenField1,TextBox1');
            });
            $("#TextBox2").attr("emptytip", "<请双击选择角色>").attr("readOnly", true).dblclick(function () {
                openpage('../../Common/RoleTree.aspx?method=2&queryfield=roleid,rolename&cid=HiddenField2,TextBox2');
            });
            $("#TextBox3").attr("emptytip", "<请双击选择岗位>").attr("readOnly", true).dblclick(function () {
                openpage('../../Common/PositionTree.aspx?method=2&queryfield=positionid,positionname&cid=HiddenField3,TextBox3');
            });
