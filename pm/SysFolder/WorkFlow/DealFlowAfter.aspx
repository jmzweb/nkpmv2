<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DealFlowAfter.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.DealFlowAfter" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        input{padding:3px;}
        a.user{text-decoration:none;color:blue;padding:3px;}
        span.user{padding:3px;}
    </style>
