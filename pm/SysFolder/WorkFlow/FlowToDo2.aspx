...
<!--
		...
		({
			...
			colModel : [
				{ display: '选择', name: 'rowindex', width: 30, sortable: false, align: 'center'},
				...
				{display: '步骤名称', name: 'taskname', width: 100, sortable: false, align: 'center' },
        ...
        function app_transfer(cmd, grid) {
            ...
            arr.push("</td><tr>")
            ymPrompt.confirmInfo({ message: arr.join(""),
                width: 360,
                height: 200,
                title: '任务转交',
                maxBtn: false,
