<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlowQuery.aspx.cs" Inherits="EZ.WebBase.SysFolder.WorkFlow.Admin_OnDeal" %>
...
<!--
    ...
    $("#flex1").flexigrid
			(
			{
			    url: '../../getdata.ashx?ds=Flow_Admin_Query',
                ...
                { display: '任务状态', name: 'InstanceState', type: 1, edit: 'select', data: '处理中|处理中,完成|完成,终止|终止,归档|归档,', defvalue: '处理中' }
			    ],
