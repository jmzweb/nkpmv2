<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Org_DeptLeft.aspx.cs" Inherits="EIS.WebBase.SysFolder.Common.PositionTree" %>
	...
	<body>
       ...
       <script type="text/javascript">
        ...
        function nodeClick(e,treeId,node)
        {
            ...
            {
                window.parent.frames["main"].location.href="Org_PosVList.aspx?tblName=T_E_Org_DeptEmployee&condition=PositionId='"+node.id+"'"; 
            }
            else{
                window.parent.frames["main"].location.href="Org_PosVList.aspx?tblName=T_E_Org_DeptEmployee&condition=DeptID='"+node.value+"'";             
            }
        }
