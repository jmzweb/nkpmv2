...
<!--
	...
	({
        ...
        initCond:"<%=InitCond %>",
	    params:[{name:"queryid",value:"Org_DeList"}
			    ,{name:"cryptcond",value:""}
			    ,{name:"sindex",value:"<%=sindex %>"}
			    ,{name:"condition",value:"DeptEmployeeType=1 and EmployeeId='<%= Request["EmployeeId"] %>'"}
			    ],
	    colModel : [
            ...
            {display: '默认岗位', name : 'IsDefault', width : 68, sortable :true, align: 'left',hide:false,renderer:fnDefault}

		    ],
	    buttons : [
		    {name: '添加兼职', bclass: 'add', onpress : app_add },
    ...
    function fnDefault(v,row)
    {
      ...
      if(v == 1)
        return "&nbsp;是&nbsp;<a href=\"javascript:setDefault('"+empid+"','"+recid+"',0);\">取消</a>";
      else
        return "&nbsp;否&nbsp;<a href=\"javascript:setDefault('"+empid+"','"+recid+"',1);\">设置</a>";
    }
