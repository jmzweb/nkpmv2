<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeLimitEdit.aspx.cs" Inherits="EIS.WebBase.SysFolder.Limit.GradeLimitEdit" %>
...
<head id="Head1" runat="server">
	...
	<body>
        ...
        <fieldset> 
            <legend>&nbsp;权限对象：<%=base.GetParaValue("roleName") %></legend>
        ...
        $(function () {
            ...
            $("#btnSave").click(function(){
                ...
                for (var i = 0; i < nodes.length; i++) {
                    ...
                    if(chkobj.checked && nodes[i].id!=''){
                        arrCode.push(nodes[i].id);
                    }
                }

                var ret = EIS.WebBase.SysFolder.Limit.GradeLimitEdit.SaveLimit("<%=webId %>","<%=roleId %>",arrCode);
                if(ret.error){
