...
<!--
	var gb = '<%=(!IsSysAdmin && Request["grade"]=="1")%>'=='True';
	var cond = gb ? "CompanyID=[QUOTES][!CompanyID!][QUOTES]":"";
    $("#flex1").flexigrid
    ({
        ...
        colModel: [
            ...
            { display: '角色名称', name: 'RoleName', width: 140, sortable: true, align: 'left', renderer: transName },
            { display: '角色编码', name: 'RoleCode', width: 120, sortable: false, align: 'left',hide:true },
            { display: '所属单位', name: 'CompanyName', width: 120, sortable: false, align: 'left' }
            ],
        buttons: [
        ...
        searchitems: [{ display: '角色名称', name: 'RoleName', type: 1},{ display: '所属单位', name: 'CompanyName', type: 1}],
    ...
    function transName(v, row) {
		...
		var url = "QX_RoleEdit.aspx?grade=<%=GetParaValue("grade") %>&roleId=" + empId + "&rolename=" + v;
