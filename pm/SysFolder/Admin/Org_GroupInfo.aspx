...
<body>
    ...
    <tbody>
      <tr>
        ...
        <td  >
            <asp:TextBox ID="txtDeptName" Width="460px" CssClass="TextBoxInChar" runat="server"></asp:TextBox>
    ...
    <tr>
        <td  width="18%">&nbsp;集团编码</td>
        <td >
            <asp:TextBox ID="txtDeptCode" Width="460px"  CssClass="TextBoxInChar" runat="server"></asp:TextBox>
            &nbsp;<span class='RequiredStar'>*</span>
         </td>
      </tr>
      <tr>
        <td>&nbsp;集团简称</td>
        <td>
            <asp:TextBox ID="txtDeptAbbr" Width="460px"  CssClass="TextBoxInChar" runat="server"></asp:TextBox>
            &nbsp;<span class='RequiredStar'>*</span>
        </td>
        </tr>
        <tr>
        <td>&nbsp;管理员账号</td>
        <td>
            <asp:TextBox ID="txtDeptSa" Width="460px"  CssClass="TextBoxInChar" runat="server"></asp:TextBox>
            &nbsp;<span class='RequiredStar'>*</span>
        </td>
      </tr> 
      <tr>
