<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Org_DeptEdit.aspx.cs" enableEventValidation="false" Inherits="EIS.WebBase.SysFolder.Org.Org_DeptEdit" %>
        ...
        <div id="tabControl">
            ...
            <tbody>
              <tr>
                ...
                <td  >
                    <asp:TextBox ID="txtCode" CssClass="TextBoxInChar" Enabled="false" runat="server"></asp:TextBox>
                </td>
                <td  width="100">&nbsp;组织简称</td>
                <td >
                    <asp:TextBox ID="txtAbbr" CssClass="TextBoxInChar" Enabled="false" runat="server"></asp:TextBox>
                </td>
            </tr>
            ...
            <tr>
                <td >&nbsp;组织名称</td>
                <td  >
                    <asp:TextBox ID="txtName" CssClass="TextBoxInChar" Enabled="false" runat="server"></asp:TextBox>
                </td>

                <td>&nbsp;组织全称</td>
                <td >
                    <asp:TextBox ID="txtFullName" CssClass="TextBoxInChar" Enabled="false" runat="server"></asp:TextBox>
            ...
            <tr>
                <td>&nbsp;组织类型</td>
                <td>
                    <asp:DropDownList ID="listType" runat="server" Enabled="false">
                    </asp:DropDownList>
                </td>
                <td>&nbsp;组织状态</td>
                <td >
                    <asp:RadioButtonList ID="RadioState" runat="server"  Enabled="false"
                ...
                <td>&nbsp;组织级别</td>
                <td>
                    <asp:DropDownList ID="listProp" runat="server" Enabled="false">
                    </asp:DropDownList>
                </td>
                <td>&nbsp;组织WBS</td>
                <td >
                    <asp:TextBox ID="txtWbs" CssClass="TextBoxInChar Read" runat="server" Enabled="false"></asp:TextBox>
                </td>
            </tr> 
            <tr>
                <td>&nbsp;所属区域</td>
                <td>
                    <asp:DropDownList ID="listArea" runat="server" Enabled="false">
                    </asp:DropDownList>
                </td>
                <td>&nbsp;成本中心编码</td>
                <td >
                    <asp:TextBox ID="txtCostCode" CssClass="TextBoxInChar" runat="server" Enabled="false"></asp:TextBox>
                </td>
                </tr>
              <tr>
                <td>
                ...
                <tr>
                    <td>&nbsp;排序</td>
                    <td>
                        <asp:TextBox ID="txtOrder" CssClass="TextBoxInChar" runat="server" Enabled="false"></asp:TextBox>
                    </td>
                    <td>&nbsp;工作日历</td>
                    <td>
                ...
                <tr><td colspan="4">
                    <div style='line-height:2;color:Red;'>&nbsp;注：请选择负责人岗位、副负责人岗位、分管领导（或分管领导岗位）。</div>
                </td></tr>
            </tbody>
            </table>
            </div>
