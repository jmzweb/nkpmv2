<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefRoleLimitEdit.aspx.cs" Inherits="EIS.Sudio.SysFolder.Permission.DefRoleLimitEdit" %>
...
<body>
    <form id="form1" runat="server">   
            <div class="menubar">
            <div class="topnav">
                <span style="float:left;margin-left:10px">目前角色：<%=Request["rolename"] %>&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    切换系统：
...
<script type="text/javascript">
    var _curClass = EIS.Sudio.SysFolder.Permission.DefRoleLimitEdit;
