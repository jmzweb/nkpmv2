...
<!--
		...
		(
		{
			...
			{ display: '任务名称', name: 'InstanceName', width: 360, sortable: true, align: 'left', renderer: transName },
		...
		function transName(fldval,row) {
			...
			var htmlArr = [];
			htmlArr.push("<a title='" + fldval + "' href=\"javascript:viewTask('" + instanceId + "');\">" + fldval + "</a>&nbsp;");
			return htmlArr.join("");
		}
