<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefPositionLimitEdit.aspx.cs" Inherits="EIS.Sudio.SysFolder.Permission.DefPositionLimitEdit" %>
...
<body>
    <form id="form1" runat="server">   
            <div class="menubar">
            <div class="topnav">
                <span style="float:left;margin-left:10px">目前岗位：<%=Request["rolename"] %>&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    切换系统：
                ...
                <span style="float:right;margin-right:20px">
                    ...
                    &nbsp;&nbsp;
                        <a id="A3" href="javascript:SaveRoleLimit();"  title="保存该角色权限">保存</a>
                 </span>       
            </div>
            </div>
	...
	<script type="text/javascript">
	    var _curClass = EIS.Sudio.SysFolder.Permission.DefPositionLimitEdit;
