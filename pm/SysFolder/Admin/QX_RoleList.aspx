...
<!--
    ...
    $("#flex1").flexigrid
			(
			{
                ...
                { display: '所属组织', name: 'CompanyName', width: 100, sortable: true, align: 'left', hide: false, renderer: false},
                ...
                { display: '说明', name: 'RoleNotes', width: 180, sortable: true, align: 'left', hide: false, renderer: false}
                ...
                { display: '所属组织', name: 'CompanyName', type: 1 }
			    ],
			    sortname: "OrderID",
			    sortorder: "asc",
			    usepager: true,
    ...
    function app_add(cmd, grid) {
        openCenter("../AppFrame/AppInput.aspx?tblName=T_E_Org_Role", "_blank", 800, 500);
    }
    ...
    function setEmp(roleId) {
        openCenter("../AppFrame/AppQuery.aspx?tblName=Q_Org_RoleEmpSet2&defaultvalue=@roleid=" + roleId + "&replacevalue=@proleId=" + roleId, "_blank", 720, 500);
    }
    function viewEmp(roleSQL) {
        openCenter("../AppFrame/AppQuery.aspx?tblName=Q_Org_SQLRoleEmp&defaultvalue=@RoleSQL=" + roleSQL, "_blank", 720, 500);
    }
    ...
    function roleEdit(roleId) {
        openCenter("../AppFrame/AppInput.aspx?tblName=T_E_Org_Role&condition=_AutoID='" + roleId + "'", "_blank", 800, 500);
    }
