<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Org_EmpMove.aspx.cs" Inherits="EIS.WebBase.SysFolder.Org.Org_EmpMove" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            jQuery("#txtPositionName2").click(function () {
                _openPage('Org_PosSel.aspx?method=1&limit=1&queryfield=positionid,positionname,deptid,deptname&cid=HiddenField1,txtPositionName2,HiddenField2,txtDeptName2'
                );
            }).emptyValue({
                empty: "<请点击选择岗位>",
                className: "gray"
...
<body>
    ...
    <div class="menubar">
        <div class="topnav">
                    ...
                    <a href="javascript:" onclick="winClose();" >关闭</a> &nbsp;&nbsp;
                    </span>
        </div>
    </div>
    ...
    <tbody>
      <tr>
        ...
        <td  >
            <asp:TextBox ID="txtEmpName" Enabled="false" CssClass="TextBoxInChar" runat="server"></asp:TextBox>
        </td>
    </tr>
      ...
      <tr>
        <td>&nbsp;原岗位名称</td>
        <td >
            <asp:TextBox ID="txtPositionName" Enabled="false" CssClass="TextBoxInChar" runat="server"></asp:TextBox>
     ...
     <tr>
        <td>
            &nbsp;原部门名称</td>
        <td>
            <asp:TextBox ID="txtDeptName" Enabled="false" CssClass="TextBoxInChar" runat="server"></asp:TextBox>
        </td>
     </tr>
