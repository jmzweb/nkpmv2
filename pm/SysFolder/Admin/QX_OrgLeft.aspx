<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefQueryList.aspx.cs" Inherits="EIS.Sudio.SysFolder.DefFrame.DefQueryList" %>
...
<!--
	...
	({
	    ...
	    params: [{ name: "queryid", value: "Org_OrgLimit" }
	...
	function transName(v, row) {
        ...
        return "<a href=\"QX_OrgEdit.aspx?empId=" + empId + "&empname=" + empName + "\" target='main'>" + v + "</a>";
    }
	function app_select() {
