<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Org_DeptMerge.aspx.cs" Inherits="EIS.WebBase.SysFolder.Org.Org_DeptMerge" %>
...
<body>
    ...
    <div id="maindiv" style="text-align:left;margin-left:auto;margin-right:auto;">
        ...
        <table width="600" class="outerTbl" align="center">
            <caption style="font-weight:bold;font-size:12pt;line-height:30px;">组织机构合并</caption>
            <tr>
                <td>
                            ...
                            <tr>
                                <td colspan="2" style="background-color:#eee;">
                                    <div style="padding-left:40px;line-height:1.8;position:relative;">
                                        ...
                                        合并之后，系统会把当前组织下的岗位、人员复制到目标组织下面，当前组织自动失效
                                        ；系统会重新生成部门ID和岗位ID，人员权限中通过部门或者岗位继承的那部分权限将会丢失。
                                    </div>
                                </td>
                            </tr>
                        </tbody>
            ...
            <tr>
                <td>
                   ...
                   <div style="padding:3px;">
                        ...
                        <button  type="button" id="btnMove" class="imgbutton"><img alt="确认合并" src="../../img/common/site.png" />&nbsp;确认合并&nbsp;</button>
...
<script type="text/javascript">
    jQuery(function () {
        ...
        $("#btnMove").click(function () {
            ...
            if (!confirm("你确认要合并 [<%=DeptName%>] 至 [" + pName + "] 吗？"))
                return;
