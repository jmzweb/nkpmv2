        ...
        success: function (data) {
            ...
            for (var proi in sdata.prolist) {
                ...
                azcode[prodatai.CITYD].list.push("<div class='proitem' RISKGRADE='", prodatai.RISKGRADE, "' PROJECTSTAGE='", prodatai.PROJECTSTAGE,
                    ...
                    "<img src='img/fdir.png' class='imgdir'/><p>", prodatai.PROJECTNAME.replace("-", "<br />")+"</p>",
            ...
            if ($next.length == 0) {
                ...
                $.ajax({//如果没有加载过 就加载项目轴
                    ...
                    success: function (data) {
                        ...
                        var sdata = eval('(' + data + ')');
                        var lphtml = ["<div class='linepoint linepoint" + $t.attr("PROJECTSTAGE") + "'><i class='iconfont imgsj'>&#xe6a3;</i><div class='probtns protop'>\
                    <a href='javascript:void(0)' openlayer='BizFrame.aspx?funCode=XMKCK&CorrelationCode=" + autoid + "&readonly=1'>查看项目详情</a>\<a href='javascript:void(0)' openlayer='" + url + "'>编辑项目详情</a>\
                    ...
                    <a href='javascript:void(0)' openlayer='../AppFrame/AppInput.aspx?TblName=T_PM_P_RiskInfo&cpro=CorrelationCode=" + autoid + "^1|CorrelationName=" + $t.attr("proname") + "^1&sindex=1'>添加风险事件</a>"];
                        ...
                        if (ProjectStage == "拟投") {
                            lphtml.push("</div><ul class='lineul'>");
                            ...
                            lphtml.push("</div><div class='clear'></div><div class='probtns tqsjjl'><b>", tqtitle, "事件记录：</b></div><ul class='lineul thlineul'>");
                            lphtml.push(render(sdata.proinfo, "<li class='select{{REVIEWERSTATE}}'><p class='plinel'></p><p class='pliner'></p><i class='iconfont'>&#xe6f5;</i>\
                            <a href='javascript:void(0)' openlayer='../AppFrame/AppInput.aspx?{{TBLPARA}}&biz=1&maincol=CorrelationCode&cpro=CorrelationCode=" + autoid +
                            ...
                            lphtml.push("<div class='clearth'></div><div class='probtns'><b>", thtitle, "事件记录：</b>");
