...
<body style="margin: 1px;" scroll="no">
    ...
    <div class="tree-left">
        <%=NTJT.Web.SysFolder.AppFrame.echartService.getTreecb() %>
    </div>
    <div class="btntabs"> 
        <a class="select">储备库</a>
        <a href="AppQueryxmzb.aspx?TblName=T_PM_P_ProjectInfo&funCode=XMKCK&checkoutshow=1&sindex=4&ps=拟投" value="拟投">拟投库</a>
        <a href="AppQueryxmzb.aspx?TblName=T_PM_P_ProjectInfo&funCode=XMKCK&checkoutshow=1&sindex=4&ps=已投" value="已投">已投库</a>
        <a href="AppQueryxmzb.aspx?TblName=T_PM_P_ProjectInfo&funCode=XMKCK&checkoutshow=1&sindex=4&ps=退出" value="退出">退出库</a>
    </div>
</body>
</html>
