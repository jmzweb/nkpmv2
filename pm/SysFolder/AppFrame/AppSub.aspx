<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppSub.aspx.cs" Inherits="EZ.WebBase.SysFolder.AppFrame.AppSub" %>
...
<body>
    ...
    <div id="maindiv">
        ...
        <div class="btbar">
            ...
            <input type="button" class="btnSave2 btn01" value="保存后添加" />
...
<script type="text/javascript">
    ...
    var _workflowCode = "";
    var _nodeCode = "";
    var _curClass = EZ.WebBase.SysFolder.AppFrame.AppSub;
...
<script type="text/javascript">
    ...
    $(function () {
        if (_isNew) $(".btnAdd,.btnAdd2,.btnCopy,").prop("disabled", true);
            ...
            if (_sysSave()) {
                $.noticeAdd({ text: '保存成功！', stayTime: 500, onClose: function () {
                    ...
                    for (var i = 0; i < fieldArr.length; i++) {
                        var v = _sys.getValue(fieldArr[i].name, false, _rowId);
                        if (_tmplRowId != v)
