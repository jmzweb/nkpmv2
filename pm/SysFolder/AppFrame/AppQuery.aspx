...
<!--
    ...
    var _curClass = NTJT.Web.SysFolder.AppFrame.AppQuery2;
    ...
    function app_detail(cmd,grid)
    {
        ...
        { 
            <%if (string.IsNullOrEmpty(base.GetParaValue("funCode")))
              { 
              %>
            var url="<%=base.ResolveUrl("~")%>SysFolder/AppFrame/AppDetail.aspx?TblName=<%=tblname %>&Condition=K_AUTOID=[QUOTES]"+editId+"[QUOTES]";
