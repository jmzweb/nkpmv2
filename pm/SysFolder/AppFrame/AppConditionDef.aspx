<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppConditionDef.aspx.cs" Inherits="EZ.WebBase.SysFolder.AppFrame.AppConditionDef" %>
...
<head runat="server">
	...
	#sortable1 li, #sortable2 li { margin: 0 5px 2px 5px; padding: 4px; font-size: 1.0em; width: 140px;text-align:center;cursor:move;}
	table.frametbl
    {
	...
	function save()
	{
	   var querylist= $('#sortable2').sortable('toArray');
        ...
        var ret = EZ.WebBase.SysFolder.AppFrame.AppConditionDef.saveQuery(querylist, "<%=tblName %>", "<%=sindex %>");
	    if(ret.error)
	    {
...
<body style="padding:0px;margin:0px;height:100%;">
    ...
    <tr><th align="center" height="30">列表字段（双击）</th><th align="center">查询字段（双击）</th></tr>
