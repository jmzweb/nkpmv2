...
<body style="margin: 1px;" scroll="no">
    ...
    <style type="text/css">
        ...
        .tree-left li a.select {color:#ff6a00; }
        .btntabs { position:fixed;right:0px;top:14px;}
        .btntabs a { color:#333;font-size:16px;text-decoration:none;margin-right:10px;}
        .btntabs a.select { color:#ff6a00;}
    </style>
    <div class="tree-left">
        <%=NTJT.Web.SysFolder.AppFrame.echartService.getTree() %>
    </div>
    <div class="btntabs"> 
        <a href="javascript:void(0)" value="">全部</a>
        <a href="javascript:void(0)" value="储备">储备库</a>
        <a href="javascript:void(0)" value="拟投">拟投库</a><a href="javascript:void(0)" value="已投">已投库</a><a href="javascript:void(0)" value="退出">退出库</a>
    </div>
</body>
</html>
...
<script type="text/javascript"> 
    ...
    $(".tree-left a").click(function(){
        var $t=$(this);
        $(".tree-left a.select").removeClass("select");
        $t.addClass("select");
    ...
    $(".btntabs a[value]").click(function(){
        $(this).addClass("select").siblings().removeClass("select");
        
        $(".sDiv2 #ProjectStage").val($(this).attr("value"));
        $(".sDiv2 #PROJECTSTAGE").val($(this).attr("value"));
        app_query();
    });
    setTimeout(function(){ 
        var ps='<%=GetParaValue("ps")%>';
        if(ps){
            $(".btntabs a[value='"+ps+"']").trigger("click");
        }
    },1000);
</script>
...
<script type="text/javascript">
    ...
    function __fnLoad(){
        ...
        //$(".sDiv2 #ProjectStage").parent().parent().hide();
        //$(".sDiv2 #PROJECTSTAGE").parent().parent().hide();
