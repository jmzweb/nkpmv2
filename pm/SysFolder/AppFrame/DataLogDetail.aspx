<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppDataLog.aspx.cs" Inherits="EZ.WebBase.SysFolder.AppFrame.AppDataLog" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .logtbl{width:100%;table-layout:fixed;border-collapse:collapse;margin-bottom:5px;}
        ...
        .tblname,.autoid{color:Blue;font-weight:bold;display:inline-block;padding:2px;}
...
<body scroll="auto">
    ...
    <br />
        <table class="normaltbl" style="width:900px;" border="0" cellpadding="0" cellspacing="0">
        <caption>
            业务数据修改日志
        </caption>
            <tr>
            ...
            <tr>
                <td>&nbsp;信息摘要</td>
                <td colspan="3"><div style="overflow:auto;"><%=LogModel.Message %></div></td>
            </tr>
            <tr>
