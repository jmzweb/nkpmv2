    ...
    function createMenu(data,mainMenu)
    {
        ...
        for(var i=0;i<children.length;i++)
        {
            ...
            if(pmenu.hasChildren)
            {
                if(pmenu.isexpand)
                {
                    menuHtml.push("<h3 class='f14' title='",pmenu.text,"'><span class='switchs cu on' title='展开与收缩'></span>",pmenu.text,"</h3>");
                    menuHtml.push("<ul>");
                }else{
                    menuHtml.push("<h3 class='f14' title='",pmenu.text,"'><span class='switchs cu' title='展开与收缩'></span>",pmenu.text,"</h3>");
                ...
                for(var j=0;j<pmenu.ChildNodes.length;j++)
                {
		            ...
		            var url=smenu.value;
                    var snum=smenu.ChildNodes==null?0:smenu.ChildNodes.length;
                    menuHtml.push("<li id='_MP",smenu.id,"' title='",smenu.text,"' class='sub_menu'><a href=\"javascript:_MP('",smenu.id,"','",url,"','",path.join(" > "),"','"+smenu.tag+"',"+snum+");\" hidefocus='true' style='outline:none;'>",smenu.text,"</a></li>");
                }
                menuHtml.push("</ul>");
            }
            else
            {
                ...
                {
		            var url=pmenu.value;
                    menuHtml.push("<h3 class='f14'><span class='cu' title='点击操作'></span><a href=\"javascript:_MP('",pmenu.id,"','",url,"','",path.join(" > "),"','"+pmenu.tag+"');\" hidefocus='true' style='outline:none;'>",pmenu.text,"</a></h3>");
                }
                else
                {
                    menuHtml.push("<h3 class='f14' title='",pmenu.text,"'><span class='cu' title='点击操作'></span>",pmenu.text,"</h3>");
                }
            }
        }
