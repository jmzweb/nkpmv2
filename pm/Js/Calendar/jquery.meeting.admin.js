 ...
 (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        function render() {
            ...
            if (option.onAfterRender && $.isFunction(option.onAfterRender)) {
                option.onAfterRender(option);
            }
        }
        ...
        function BuildDaysAndWeekView(startday, l, events, config) {
            ...
            html.push("</table>");
            html.push("</div>");
            var mHeight=(option.endTime-option.startTime)*42;
            ...
            html.push("<table style=\"height: "+mHeight+"px\" id=\"tgTable\" class=\"tg-timedevents\" cellspacing=\"0\" cellpadding=\"0\"><tbody>");
        ...
        function BuildDayScollEventContainer(ht, dayarrs, events) {
            ...
            if(h>=option.endTime)
            {
                ht.push("<div id=\"tgnowptr\" class=\"tg-nowptr\" style=\"display:none;left:0px;top:", mHg, "px\"></div>");
            }
            else{
            ...
            for (var i = 0; i < l; i++) {
                ...
                // Today
                if (istoday) {
                    ht.push("<div style=\"margin-bottom: -"+mHeight+"px; height:"+mHeight+"px\" class=\"tg-today\">&nbsp;</div>");
                }
                //var eventC = $(eventWrap);
                //onclick=\"javascript:FunProxy('rowhandler',event,this);\"
                ht.push("<div  style=\"margin-bottom: -"+mHeight+"px; height: "+mHeight+"px\" id='tgCol", i, "' class=\"tg-col-eventwrapper\">");
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
                ...
                if (option.onBeforeRequestData && $.isFunction(option.onBeforeRequestData)) {
                    option.onBeforeRequestData(1,option);
                }
        ...
        function weekormonthtoday(e) {
            ...
            if (option.onWeekOrMonthToDay) {
                option.onWeekOrMonthToDay(daystr);
            }
            else {
        ...
        //根据时间计算top
        function gP(h, m) {
            return (h-option.startTime) * 42 + parseInt(m / 60 * 42);
        }
        ...
        function gW(ts1, ts2) {
            ...
            return { sh: t2+option.startTime, sm: t3, eh: t5+option.startTime, em: t6, h: ts2 - ts1 };
        }

        //计算起始时间，结束时间级高度差（参数：y1起始top，y2修整后的top，pt事件对象的top）
        function gH(y1, y2, pt) {
            ...
            var t5 = parseInt(t4);
            var t6 = t4 - t5 >= 0.5 ? 30 : 0;
            return { sh: t2+option.startTime, sm: t3, eh: t5+option.startTime, em: t6, h: sy2 - sy1 };
        }
        ...
        function tc(d) {
            function zc(c, i) {
                var d = "";
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	...
                    	+ i18n.xgcalendar.i_delete + '</span> ]&nbsp; </div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
        ...
        function dayupdate(data, start, end,e) {
            if (option.quickUpdateUrl != "" && data[8] == 1 && option.readonly != true) {
                ...
                if (option.quickUpdateHandler && $.isFunction(option.quickUpdateHandler)) {
                    option.quickUpdateHandler.call(this, param ,data,option,e);
                    return false;
                }
                else {
                    option.onBeforeRequestData && option.onBeforeRequestData(4,option);
        ...
        function ResizeView() {
            ...
            if (_viewType == "day" || _viewType == "week") {
                ...
                $dvtec.height(calH);
                //debugger;
                if (typeof (option.scoll) == "undefined" && typeof (option.startHour) == "undefined") {
                    //设置滚动条的位置
                ...
                else if(typeof (option.startHour) != "undefined"){
                    var h = option.startHour;
                    var m = 0;
                    var th = gP(h, m);
                    var ch = $dvtec.attr("clientHeight");
                    var sh = th - 0.5 * ch;
                ...
                else if(typeof (option.scoll) != "undefined"){
        ...
        function dragStart(type, e) {
            ...
            switch (type) {
                case "dw1": //周日视图的	快速新增事件 单日
                    if(option.onBeforeDrag && $.isFunction(option.onBeforeDrag)){
                        if(option.onBeforeDrag(1, obj.attr("abbr"))){
                ...
                case "dw2": //周日视图的快速新增事件 全天跨天
                    ...
                    if(option.onBeforeDrag && $.isFunction(option.onBeforeDrag)){
                        if(option.onBeforeDrag(2, $(source).attr("abbr"))){
                ...
                case "m1": //月视图的快速新增事件
                    ...
                    if(option.onBeforeDrag && $.isFunction(option.onBeforeDrag)){
                        if(option.onBeforeDrag(3, $(source).attr("abbr"))){
