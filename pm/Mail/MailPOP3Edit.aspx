...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../css/AppInput.css"/>
    ...
    <style type="text/css">
        table.normaltbl input.TextBoxInChar{
...
<body  scroll="auto">
    ...
    <div class="maindiv">
    <br />
        <table class="normaltbl" style="width: 600px; height: 107px" border="1" align="center" cellpadding="10" cellspacing="0">
            <caption>
                电子邮箱设置
            </caption>
            <tbody>
            <tr>
                <td width="140">&nbsp;&nbsp;电子邮件地址：</td>
                <td >
