...
<head runat="server">
    ...
    <style type="text/css">
        *{margin:0px;padding:0px;}
        ...
        .leftzone{background:white;width:220px;border:1px solid #b0c4de;float:left;
...
<iframe id="mainframe2" name="mainframe2" width="100%" height="100%" frameborder="0" scrolling="auto" src="mailReceive.aspx?folderId=0&read=<%=Request["read"] %>"></iframe>
</body>
</html>
