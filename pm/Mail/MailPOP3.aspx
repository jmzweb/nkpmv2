...
<!--
	...
	colModel : [
		...
		{ display: '电子信箱', name: 'emailadrr', width: 180, sortable: true, align: 'left', renderer: rndMail },
		{ display: '操作', name: 'emailadrr', width: 60, sortable: true, align: 'center', renderer: rndFetch },
	...
	buttons : [
		{name: '添加邮箱', bclass: 'add', onpress : app_add},
	...
	searchitems :[
		{ display: '电子信箱', name: 'emailadrr', type: 1 }
		],
	sortname: "",
	sortorder: "",
	usepager: true,
...
    function rndMail(v, row) {
        var recId = $(row).attr("id");
        return "<a href='MailPOP3Edit.aspx?editid="+recId+"' target='_blank'>" + v + "</a>";
    }
    function rndFetch(v, row) {
        return "<a href=\"javascript:fetchMail('" + v + "');\">【收信】</a>";
    }
    function fetchMail(mailAddr) {
        EIS.Web.Mail.MailPOP3.StartPop3(mailAddr).value;
    }
	function app_start() {
