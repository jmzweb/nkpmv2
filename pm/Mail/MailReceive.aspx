...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .flag{width:16px;margin:3px 2px 0px 5px;height:14px;float:left;overflow:hidden;padding:0px;}
...
<!--
	...
	({
		...
		colModel: [
		{ display: '选择', name: 'autoid', width: 30, sortable: false, align: 'center', renderer: tranchk },
		{ display: '状态', name: 'state', width: 34, sortable: true, align: 'center', renderer: rendState },
		...
		{ display: '发送时间', name: 'sendtime', width: 120, sortable: true, align: 'center' },
        { display: '操作', name: 'autoid', width: 80, sortable: false, align: 'center', renderer: fnTransfer }
		],
		buttons: [
		...
		searchitems: [
		{ display: '状态', name: 'state', type: 1, edit:'select',data:'未读|0,已读|1',defvalue:'<%=Request["read"] %>' },
