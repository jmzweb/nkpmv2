<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Publish.aspx.cs" Inherits="EIS.Studio.DrawTools.Publish" %>
...
<!--
        ...
        checkClient = false;
        directLink = "DrawTools.application?para=<%=loginKey %>";
        function isIE() { //ie
    ...
    <table width="100%" cellpadding="0" cellspacing="2" border="0">
        ...
        <tr>
            <td style="background-color:#1c5280;height:50px;border:2px solid #ddd;">
                 <span class="BannerTextApplication">流程设计工具<span id="tip" style="display:none;">（请使用IE内核模式）</span></span>
            </td>
        </tr>
        <!-- End Banner -->
        <!-- Begin Dialog -->
                    ...
                    <tr>
                        <td width="496">
                            ...
                            <table id="BootstrapperSection" border="0">
                                ...
                                <tr>
                                    <td colspan="2">
                                        如果已经安装了这些组件，您可以立即<span class="JustThisApp"><a href="DrawTools.application">启动</a></span>该应用程序。否则，请单击下面的按钮，安装系统必备组件并运行该应用程序。
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
