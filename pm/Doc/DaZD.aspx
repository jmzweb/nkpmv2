<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaCatalog.aspx.cs" Inherits="EIS.Web.Doc.DaZD" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            if(node.id){
                window.open("DaZDEdit.aspx?nodeId=" + node.id + "&time=" + Math.random(), "main");
            }
        }
    ...
    <script type="text/javascript">
        var _curClass = EIS.Web.Doc.DaZD;
