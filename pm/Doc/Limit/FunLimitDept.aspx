<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FunLimitDept.aspx.cs" Inherits="EIS.Web.Doc.Limit.FunLimitDept" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    table.bodystyle{
     ...
     table.bodystyle td,table.bodystyle th{
         padding:0px;
         text-align:center;
         border:1px solid #a0a0a0;
         }
                ...
                <div id="TContent">
                    ...
                    <thead>
                        <tr class="table_title">
                            ...
                            <th title="浏览文件夹">浏览</th>
                            <th title="新建子文件夹">新建</th>
                            <th title="上传文件">上传</th>
                            <th title="删除该文件夹">删除</th>
                            <th title="修改文件夹的属性和授权">管理</th>
                            <th title="">备用</th>
                            <th title="">备用</th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    var _curClass = EIS.Web.Doc.Limit.FunLimitDept;
