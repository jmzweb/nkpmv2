...
<head id="Head1" runat="server">
	...
	<body>
		<form id="Form1" method="post" runat="server">
         <div class="toolbar" style="">
            ...
            <input type="text" style="width:70px;display:none;" class="search" id="txtSearch" />
            <button id="btnSearch" type="button"><img alt="查找" src="../img/common/search.png" />查找文件</button>
        </div>
    ...
    <script type="text/javascript">
        ...
        {
            window.parent.frames["main"].location ="DocList.aspx?folderId=" + node.id + "&treeId=<%=treeId %>&time=" + Math.random();
        }
        ...
        $(function () {
            ...
            $("#btnSearch").click(function(){
                window.parent.frames["main"].location = "DocSearch.aspx";
                //searchNode();
            });
