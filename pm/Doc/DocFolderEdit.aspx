...
<head runat="server">
    ...
    <style type="text/css">
        ...
        input[type=submit],input[type=button],button{padding:0px 10px;height:28px;}
     ...
     <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            $(".btnAddDept").click(function () {
                openpage("../SysFolder/Common/DeptTree.aspx?method=2&queryfield=deptid,deptname&cid=Hidden1,Hidden2&callback=afterSelDept");
            });
            ...
            $("#btnTemp").click(function(){
                window.location = "GenFolderTmpl.aspx?pfolderId=<%=folderId %>";
            });
...
<body class="bgbody">
    ...
    <table width="580">
        ...
        <br />
            <button type="button" id="btnTemp">从模板创建</button>
            &nbsp;
