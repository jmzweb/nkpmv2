<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocView_Tree.aspx.cs" Inherits="EIS.Web.Doc.DocView_Tree" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            window.open("DocView_List.aspx?folderId=" + node.id + "&treeId=<%=treeId %>&time=" + Math.random(), "main");
        }
