<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaPositionSel.aspx.cs" Inherits="EIS.Web.Doc.DaPositionSel" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>档案存放位置选择</title>
        ...
        function load() {        
            ...
            $("#btnconfirm").click(function(e){
              ...
              var bizfields=cid.split(",");
                if(bizfields.length==1)
                {
                    window.opener.document.getElementById(bizfields[0]).value=nodes.text;
