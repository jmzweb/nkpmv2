<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDocTree.aspx.cs" Inherits="EIS.Web.Doc.MyDocTree" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            if(node.id=="myFavorite")
            {
                window.parent.frames["main"].location = "MyDocFavorite.aspx?folderId=" + node.id + "&time=" + Math.random();
            }
            else if(node.id=="myReceive"){
                window.parent.frames["main"].location ="MyDocReceive.aspx?folderId=" + node.id + "&time=" + Math.random();
            }
            else if(node.id=="myShare"){
                window.parent.frames["main"].location ="DocShareFrame.aspx?time=" + Math.random();            
            }
            else{
                window.parent.frames["main"].location ="MyDocList.aspx?folderId=" + node.id + "&time=" + Math.random();
            }
        }
