<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaPrjWBS.aspx.cs" Inherits="EIS.Web.Doc.DaPrjWBS" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            if(node.id){
                window.open("DaPrjWBSEdit.aspx?nodeId=" + node.id + "&time=" + Math.random(), "main");
            }
        }
    ...
    <script type="text/javascript">
        var _curClass = EIS.Web.Doc.DaPrjWBS;
