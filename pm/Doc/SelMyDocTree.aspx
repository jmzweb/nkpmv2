<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelMyDocTree.aspx.cs" Inherits="EIS.Web.Doc.SelMyDocTree" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function nodeClick(e,treeId,node)
        {
            ...
            {
                window.open("MyDocFavorite.aspx?folderId=" + node.id + "&time=" + Math.random(), "main");            
            }
            else if(node.id=="myReceive"){
                window.open("MyDocReceive.aspx?folderId=" + node.id + "&time=" + Math.random(), "main");                        
            }
            else{
                window.open("SelMyDocList.aspx?folderId=" + node.id + "&time=" + Math.random(), "main");            
            }
        }
