<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocFileEdit.aspx.cs" Inherits="EIS.Web.Doc.DocFileEdit" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .maindiv{margin-left:auto;margin-right:auto;width:600px;text-align:left;}
        ...
        a:hover,a.linkbtn:hover{text-decoration:none;}
...
<body class="bgbody">
    ...
    <tr>
        ...
        <td height="30" width="80" align="center">&nbsp;权限继承：</td>
    ...
    <tr>
        ...
        <td colspan="3">
            <asp:TextBox ID="TextBox1" runat="server" Width="440" CssClass="TextArea green" TextMode="MultiLine" Rows="3"></asp:TextBox>
            <br />
            </td>
    </tr>
            ...
            <td>权限设置：</td>
            <td colspan="3">
                <div style="max-height:160px;overflow:auto;overflow-x:hidden;">
                ...
                <div style="padding:3px;border-top:1px dashed #ccc;margin-top:10px;">
        ...
        <td colspan="3" align="left">
            ...
            &nbsp;
            <input type="button" value=" 复制地址 " onclick="window.clipboardData.setData('Text',TextBox1.value);"/>
            &nbsp;
