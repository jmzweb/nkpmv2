<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDocReceive.aspx.cs" Inherits="EIS.Web.Doc.MyDocReceive" %>
...
<!--
        ...
        $("#flex1").flexigrid
			(
			{
                ...
                { display: '转发时间', name: 'createtime', width: 120, sortable: false, align: 'center' }
				],
			    buttons: [
