<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DaPosition.aspx.cs" Inherits="EIS.Web.Doc.DaPosition" %>
...
<head id="Head1" runat="server">
	...
	<body>
		<form id="Form1" method="post" runat="server">
         <div class="toolbar" style="">
            ...
            <button id="btnAdd" type="button"><img alt="增加子分类" src="../img/common/add.png" />增加子分类</button>
    ...
    <script type="text/javascript">
        ...
        {
            if(node.id){
                window.open("DaPositionEdit.aspx?nodeId=" + node.id + "&time=" + Math.random(), "main");
            }
        }
    ...
    <script type="text/javascript">
        var _curClass = EIS.Web.Doc.DaPosition;
