<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDocFavorite.aspx.cs" Inherits="EIS.Web.Doc.MyDocFavorite" %>
...
<!--
        ...
        $("#flex1").flexigrid
			(
			{
                ...
                { display: '收藏时间', name: 'createtime', width: 120, sortable: false, align: 'right' }
				],
			    buttons: [
