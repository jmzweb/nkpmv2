<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocShareList.aspx.cs" Inherits="EIS.Web.Doc.DocShareList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var _curClass = EIS.Web.Doc.DocShareList;
        ...
        $("#flex1").flexigrid
			(
			{
                ...
                { display: '类型', name: 'filetype', width: 60, sortable: false, align: 'left' },
			    ...
			    buttons: [
				{ name: '返回共享', bclass: 'folderback', onpress: upShareFolder },
				{ name: '回退', bclass: 'arrowback', onpress: upFolder },
				{ separator: true },
				{ name: '上传文件', bclass: 'newfile', onpress: upLoadFile, hidden:"<%=shareLimit %>" == "1" ? 0 : 1 },
				{ name: '删除文件', bclass: 'delete', onpress: app_delete, hidden: "<%=shareLimit %>" == "1" ? 0 : 1 },
        ...
        function upShareFolder() {
            window.open("DocShareFrame.aspx", "_self");
        }

        function openFolder(folderId) {
            window.open("DocShareList.aspx?folderId=" + folderId + "&time=" + Math.random(), "_self");
        }
