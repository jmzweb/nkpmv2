<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelMyDocList.aspx.cs" Inherits="EIS.Web.Doc.SelMyDocList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../js/jquery.smartMenu.js"></script>
     <style type="text/css">
	    ...
	    .selectchk{vertical-align:middle;}
    ...
    <!--
        ...
        $("#flex1").flexigrid
			(
			{
                ...
                { separator: true },
				{ name: '确定选择', bclass: 'add', onpress: confirmSel }
				],
			    searchitems: [
        ...
        function confirmSel() {
            ...
            window.parent.frameElement.lhgDG.curWin.copyFiles(arr);
            window.parent.frameElement.lhgDG.cancel();
        }
        ...
        function openFolder(folderId) {
            window.open("SelMyDocList.aspx?folderId=" + folderId + "&time=" + Math.random(), "_self");
        }

        var curNode;
        function addFolder() {
            openCenter("MyFolderEdit.aspx?folderPId=<%=folderId %>", "_blank", 400, 300);
        }
